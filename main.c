...
int main(void)
{
  ...
  while (1)
  {
		printf("angleX=%3.5f/r",angleX_kalman);
		printf("angleY=%3.5f/r",angleY_kalman);
		printf("angleZ=%3.5f/r",angleZ_kalman);
  }
/*=====================================================================================================*/
/*=====================================================================================================*/
}
